...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, z: torch.Tensor) -> torch.Tensor:
        ...
        # preserve gradients
        quantized = z + (z_q - z).detach()  # moving average instead of hard codebook remapping
...
class VectorQuantizer2(nn.Module):
    ...
    def forward(self, z: torch.Tensor) -> torch.Tensor:
        ...
        codebook_loss = self.commitment_weight * torch.mean((z_q.detach() - z) ** 2) + \
